...
def wake_model_load(name, model):
    ...
    if name is None:
        return None
    from floris.utils.model.velocity import Bastankhah, Frandsen, Ishihara, \
        Jensen, Larsen, XieArcher
    from floris.utils.model.legacy.WakeCombination import Geometric_Sum, \
        Linear_Sum, Energy_Balance, Sum_Squares
    from floris.utils.model.legacy.WakeTurbulence import Quart, Crespo, Frandsen_turb, \
        Larsen_turb, Tian, Gao, IEC
    from floris.utils.model.legacy.EnergyCost import COE, LCOE
